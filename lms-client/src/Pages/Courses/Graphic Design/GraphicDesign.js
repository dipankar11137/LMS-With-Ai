...
import Wireframe from '../Help/Wireframe';
            ...
            <div>
              ...
              <div className="mt-5">
                ...
                <div className="bg-white">
                  ...
                  {course === 'The Brief' && (
                    <Brief course={'Graphic Design'} onDown={onDown} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'Type, Color & Icon Introduction' && (
                    <TCI course={'Graphic Design'} onDown={onDown} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'Prototyping a App - Introduction' && (
                    <Prototyping course={'Graphic Design'} onDown={onDown} />
                  )}
                </div>
              </div>
              {/* Wireframe Feedback */}
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'Wireframe Feedback' && (
                    <Wireframe course={'Graphic Design'} onDown={onDown} />
                  )}
                </div>
              </div>
              {/* Certificate */}
        ...
        <div className="bg-white  rounded-lg p-6 pl-32 pr-20 pb-20">
          ...
          >
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/WONZVnlam6U?si=4PgdJ3bI2CNdOUSc"
            ...
            ></iframe>
            {/* Play Button */}
            <div className="absolute inset-0 flex items-center justify-center ml-[510px] mb-[138px] cursor-pointer">
              {/* <button
                onClick={() => setModalOpen(true)}
          ...
          {/* review */}
          <div className="mt-14">
            <ReviewsSection course={'Graphic Design'} />
          </div>
        </div>
      </div>
