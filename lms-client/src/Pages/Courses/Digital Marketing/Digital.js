          ...
          <div className="m-4 p-3 mt-5 ">
            ...
            <div>
              ...
              <div className="mt-3">
                ...
                <div className="bg-white">
                  {course === 'The Brief' && (
                    <Brief course={'Digital Marketing'} onDown={onDown} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-3">
                ...
                <div className="bg-white">
                  {course === 'Type, Color & Icon Introduction' && (
                    <TCI course={'Digital Marketing'} onDown={onDown} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-3">
                ...
                <div className="bg-white">
                  {course === 'Prototyping a App - Introduction' && (
                    <Prototyping course={'Digital Marketing'} onDown={onDown} />
                  )}
                </div>
              </div>
              {/* Wireframe Feedback */}
        ...
        <div className="bg-white  rounded-lg p-6 pl-32 pr-20 pb-20">
          ...
          >
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/KZLroOQKT-g?si=aIHfDL3fQe3R_eF0"
          ...
          {/* review */}
          <div className="mt-14">
            <ReviewsSection course={'Digital Marketing'} />
          </div>
        </div>
      </div>
