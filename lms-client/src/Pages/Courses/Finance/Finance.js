          ...
          <div className="m-4 p-3 mt-5 ">
            ...
            <div>
              ...
              <div className="mt-3">
                ...
                <div className="bg-white">
                  {course === 'The Brief' && (
                    <Brief course={'Finance & Accounting'} onDown={onDown} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-3">
                ...
                <div className="bg-white">
                  {course === 'Type, Color & Icon Introduction' && (
                    <TCI course={'Finance & Accounting'} onDown={onDown} />
                  )}
                </div>
              </div>
        ...
        <div className="bg-white  rounded-lg p-6 pl-32 pr-20 pb-20">
          ...
          >
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/LiWMgC2ICDg?si=vlggsrUnBwaR-DJb"
          ...
          {/* review */}
          <div className="mt-14">
            <ReviewsSection course={'Finance & Accounting'} />
          </div>
        </div>
      </div>
