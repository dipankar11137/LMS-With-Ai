          ...
          <div className="m-4 p-3 mt-5 ">
            ...
            <div>
              ...
              <div className="mt-3">
                ...
                <div className="bg-white">
                  {course === 'The Brief' && (
                    <Brief course={'Mobile App Development'} onDown={onDown} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-3">
                ...
                <div className="bg-white">
                  {course === 'Type, Color & Icon Introduction' && (
                    <TCI course={'Mobile App Development'} onDown={onDown} />
                  )}
                </div>
              </div>
        ...
        <div className="bg-white  rounded-lg p-6 pl-32 pr-20 pb-20">
          ...
          >
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/yye7rSsiV6k?si=_5kPv4Yh8S3kWU41"
          ...
          {/* review */}
          <div className="mt-14">
            <ReviewsSection course={'Mobile App Development'} />
          </div>
        </div>
      </div>
