          ...
          <div className="m-4 p-3 mt-5 ">
            ...
            <div>
              ...
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'The Brief' && (
                    <Brief course={'Data Science'} onDown={onDown} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'Type, Color & Icon Introduction' && (
                    <TCI course={'Data Science'} onDown={onDown} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'Prototyping a App - Introduction' && (
                    <Prototyping course={'Data Science'} onDown={onDown} />
                  )}
                </div>
              </div>
              {/* Wireframe Feedback */}
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'Wireframe Feedback' && (
                    <Wireframe course={'Data Science'} onDown={onDown} />
                  )}
                </div>
              </div>
              {/* Certificate */}
        ...
        <div className="bg-white  rounded-lg p-6 pl-32 pr-20 pb-20">
          ...
          >
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/9R3X0JoCLyU?si=jbOacj3EqLucdO-d"
          ...
          {/* review */}
          <div className="mt-14">
            <ReviewsSection course={'Data Science'} />
          </div>
        </div>
      </div>
