...
const CoursePage = () => {
  ...
  return (
    <div className="flex  bg-gray-200 pt-16 ">
      {/* Left Sidebar */}
      <div className="w-1/3  ">
        <div className="w-1/3  h-screen overflow-y-auto ml-3 rounded-xl  fixed pb-20">
          <div className="m-4 p-3 mt-5 ">
            <div>
              <h1 className='text-2xl font-semibold mb-5 ml-1 text-slate-700'>Web Development</h1>
            </div>
            <div className="pb-5">
              <input
                type="text"
            ...
            <div>
              ...
              <div>
                ...
                <div className="bg-white ">
                  {course === 'Course Content' && <VideoSUpportCourse />}
                </div>
              </div>
              {/* The Brief */}
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'The Brief' && <VideoSUpportCourse />}
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <div className="bg-white">
                  {course === 'Wireframe Feedback' && <VideoSUpportCourse />}
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 p-8 bg-white">
        ...
        <div className="bg-white  rounded-lg p-6 pl-32 pr-20 pb-20">
          <div className=" shadow-black shadow-lg rounded-md overflow-hidden ">
            {/* Thumbnail */}

            <iframe
              className="w-full h-48 md:h-72"
              src="https://www.youtube.com/embed/I2bvoO0CoDQ?si=hAic_7JWAG-uKxy-"
            ...
            {/* Play Button */}
            <div
              className="absolute inset-0 flex items-center justify-center ml-[510px] mb-[138px] cursor-pointer"
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M14.752 11.168l-5.197-3.016A1.75 1.75 0 007.25 9.584v6.831a1.75 1.75 0 002.305 1.601l5.197-3.016a1.75 1.75 0 000-2.833z"
                  />
                </svg>
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg m-4 pt-0 w-full max-w-3xl">
            <div className="flex justify-end  -mt-9 -mr-[25px] ">
              <button
                ...
                className="text-red-500  font-bold text-3xl bg-white z-10 rounded-full px-2  hover:bg-gray-100 transition-colors duration-300 "
              >
                &times;
              </button>
            </div>
